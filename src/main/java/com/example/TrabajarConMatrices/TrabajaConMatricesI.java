...
public class TrabajaConMatricesI {
    /*
     * lenguaje y retorna las coordenadas (fila, columna) si este se encuentra
     * dentro de la matriz lenguajes, de lo contrario retorna null.
     */
    public static int[] buscarLenguaje(String lenguaje) {
        ...
        for (int i = 0; i < lenguajes.length; i++) {
            if (lenguajes[i][0].equals(lenguaje)) {
                return new int[] { i, 0 };
            }
        }
        return null;
